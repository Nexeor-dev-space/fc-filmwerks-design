 ...
 * that range:
 *   mobile   1.2 / 4.4 × 300dvh ≈ 82dvh
 *   desktop  1.6 / 5.6 × 420dvh = 120dvh
...
export function TrustSection() {
  ...
  return (
    <section
      ...
      className="relative z-10 -mt-[82dvh] bg-[#0f1012] pt-16 motion-reduce:!mt-0 md:-mt-[120dvh] md:pt-20 lg:pt-24"
    >
