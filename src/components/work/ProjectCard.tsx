...
/*
 * The project card, shared by the homepage's Featured Work grid and the
 * Portfolio gallery.
 *
 * Extracted rather than duplicated so the two cannot drift: the homepage grid
 * is meant to read as a preview of the portfolio, which only holds if they are
 * literally the same card. Everything here — the motion vocabulary, the layer
 * order, the hover treatment — was lifted from the homepage unchanged.
 */
/**
...
export const RISE = { mobile: 36, desktop: 52 } as const;
